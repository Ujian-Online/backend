                    ...
                    <table class="table table-bordered">
                        <thead>
                            <tr>
                                ...
                                <th width="55%" class="text-center" style="vertical-align: middle;">Element</th>
                                <th width="10%" class="text-center" style="vertical-align: middle;">File</th>
                                <th width="5%" class="text-center" style="vertical-align: middle;">K</th>
                                <th width="5%" class="text-center" style="vertical-align: middle;">BK</th>
